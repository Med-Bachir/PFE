...
import ShopRequest from "../../../Components/ShopeRequest";
  ...
  return (
    <Container>
      <StaticContainer>
        ...
        <Statics>
          <Item color={`red`}>
            <ItemIcon src="https://img.icons8.com/external-flaticons-flat-flat-icons/64/external-seller-auction-house-flaticons-flat-flat-icons-4.png" />
            <ItemInfo>
              <ItemTitle>Owners</ItemTitle>
              <ItemStatic>{stats.totalOwners}</ItemStatic>
            </ItemInfo>
          </Item>
          <Item color={`green`}>
            <ItemIcon src="https://img.icons8.com/color/48/user.png" />
            <ItemInfo>
              <ItemTitle>Clients</ItemTitle>
              <ItemStatic>{stats.totalClients}</ItemStatic>
            </ItemInfo>
          </Item>
          <Item color={`blue`}>
            <ItemIcon src="https://img.icons8.com/color/48/group.png" />
            <ItemInfo>
              <ItemTitle>Total Users</ItemTitle>
              <ItemStatic>{stats.totalUsers}</ItemStatic>
            </ItemInfo>
          </Item>
          <Item color={`teal`}>
            ...
            <ItemInfo>
              ...
              <ItemStatic>{stats.totalShops}</ItemStatic>
            </ItemInfo>
          </Item>
        </Statics>
      </StaticContainer>
      ...
      <StaticContainer>
        ...
        <Statics>
          <Item color={`red`}>
            <ItemIcon src="https://img.icons8.com/arcade/50/shop.png" />
            <ItemInfo>
              <ItemTitle>My Shops</ItemTitle>
              <ItemStatic>{stats.myshop}</ItemStatic>
            </ItemInfo>
          </Item>
          <Item color={`green`}>
            <ItemIcon src="https://img.icons8.com/dusk/64/purchase-order.png" />
            <ItemInfo>
              <ItemTitle>Order Incom</ItemTitle>
          ...
          <Item color={`teal`}>
            ...
            <ItemInfo>
              <ItemTitle>Totale Incom</ItemTitle>
              <ItemStatic>$ {stats?.TotalArrivedOrderValue == null ? 0 : stats?.TotalArrivedOrderValue  }</ItemStatic>
            </ItemInfo>
          </Item>
        </Statics>
      ...
      <StaticContainer>
        ...
        <Statics>
          <Item color={`red`}>
            <ItemIcon src="https://img.icons8.com/color/48/data-pending.png" alt="data-pending" />
            <ItemInfo>
          ...
          <Item color={`teal`}>
            ...
            <ItemInfo>
              ...
              <ItemStatic>{stats.WaitingOrders + stats.OnWayOrders + stats.ArrivedOrders}</ItemStatic>
            </ItemInfo>
          </Item>
        </Statics>
      </StaticContainer>
